...
public class FileManager {
    ...
    public void delete(Request request) {
        ...
        try {
            ...
            PreparedStatement preparedStatementToDelete = connection.prepareStatement("DELETE FROM chunks WHERE file_id=" + request.getFileId());
            preparedStatementToDelete.executeQuery();
